...
@NamedQueries({
    ...
    @NamedQuery(name = "TipoUsuario.findByTiusApellido", query = "SELECT t FROM TipoUsuario t WHERE t.tiusApellido = :tiusApellido")})
public class TipoUsuario implements Serializable {
    ...
    @Size(max = 30)
    @Column(name = "TIUS_APELLIDO")
    private String tiusApellido;
    ...
    public String getTiusApellido() {
        return tiusApellido;
    }

    public void setTiusApellido(String tiusApellido) {
        this.tiusApellido = tiusApellido;
    }
