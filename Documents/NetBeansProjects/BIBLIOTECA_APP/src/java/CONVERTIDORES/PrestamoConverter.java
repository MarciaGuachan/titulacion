...
public class PrestamoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        try {
            ...
            ejbFacade= (PrestamoFacade)(new InitialContext().lookup("java:global/BIBLIOTECA_APP/PrestamoFacade"));
            
            obj= this.ejbFacade.find(getKey(value));
        } catch (NamingException ex) {
            Logger.getLogger(PrestamoConverter.class.getName()).log(Level.SEVERE, null, ex);
        }
        return obj;
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Prestamo) {
            ...
            return getStringKey(o.getPresCodigo());
        } else {
