...
@FacesConverter(value = "facultadConverter")
public class FacultadConverter implements Converter {

    //@Inject
    private FacultadFacade ejbFacade;
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
       Object obj=null;
        try {
            ...
            ejbFacade= (FacultadFacade)(new InitialContext().lookup("java:global/BIBLIOTECA_APP/FacultadFacade"));
            
            obj= this.ejbFacade.find(getKey(value));
        } catch (NamingException ex) {
            Logger.getLogger(FacultadConverter.class.getName()).log(Level.SEVERE, null, ex);
        }
        return obj;
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Facultad) {
            ...
            return getStringKey(o.getFacuCodigo());
        } else {
